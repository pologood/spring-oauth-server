...
/**
 * Created by poppet on 16/10/30.
 */
public class TokenEndpointFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public TokenEndpointFilter(String path) {
        super(path);
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        String clientId = request.getParameter("appNum");
        String clientSecret = request.getParameter("appSecretKey");
